...
////////
    ...
    return <div >
        ...
        <div className="section-with-diagram__top-content App ">
            <div className="section-with-diagram__col-with-table hidden min-w-full lg:min-w-0 sm:block sm:max-w-sm ">
                ...
                <table className="section-with-diagram__table table health-table hiden sm:block "><thead>
                <tr>
                    <th scope="col"></th>
        ...
        <div className="section-with-diagram__bottom-values-row row">
            ...
            <div className="col">
                <div className="diagram-values-item">
                    ...
                    <div className="small-diagram-values pt-11 sm:pt-0">
                        <div className="small-diagram-values__titles-block">
        ...
        <div className="section-with-diagram__col-with-table  sm:hidden">
            <div className="h5 text-center text-lg sm:pl-8 sm:text-start font-medium section-with-diagram__table-title">Карта здоров&apos;я</div>
